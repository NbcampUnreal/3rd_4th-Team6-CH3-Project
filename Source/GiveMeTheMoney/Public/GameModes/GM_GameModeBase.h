...
class AGM_Character;
class AGM_Controller_Character;
...
public:
	...
	void OnEnemyKilled();
	void StartWave();
	void UpdateAmmo(int32 CurrentAmmo, int32 MaxAmmo);	// Ammo 정보 업데이트
	void ResetCharacterSpeed();	//캐릭터 스피드 초기화
